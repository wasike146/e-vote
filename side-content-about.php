...
<div class="main-content">
	...
	<div class="sidebar">
 	...
 	<div class="content">
 		...
 		<h1> People behind this web..
 		</h1><br><br><br>
 		<div class="about">
 		<p>	
 		<center> <a href="http://blog.wildan.web.id" target="_blank" title="visit my personal blog"> Wildan </a> [front-end developer] 
 		
 		</center>
 		</p>
 		<p>
 		<center>
 		<a href="https://plus.google.com/111600043032628322473/posts" target="_blank" title="see my profile"> Ivan </a> [back-end developer]
 			...
 			<h2> DISCLAIMER </h2>
 			================= <br>
 			This web is built with manually HTML, CSS, and PHP code. <br>
 			No external part is used on it. <br>
 			Thanks for visit and use. <br>
 			================= <br>
